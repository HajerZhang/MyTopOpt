...
void FiniteElement::GetEleStiffMat()
{
    ...
    // else if(dim==3){
	// 	KE.resize(24, vector<double>(24, 0.0));
	// 	double k[14];
	// 	k[0] = 1.0 / 144 * (32 - 48 * 0.3); k[1] = 1.0 / 144 * (6 + 0 * 0.3);
	// 	k[2] = 1.0 / 144 * (-8.0 + 0.0 * 0.3); k[3] = 1.0 / 144 * (6 - 24 * 0.3);
	// 	k[4] = 1.0 / 144 * (-6 + 24 * 0.3); k[5] = 1.0 / 144 * (4 + 0 * 0.3);
	// 	k[6] = 1.0 / 144 * (3 + 0 * 0.3); k[7] = 1.0 / 144 * (-6 + 0 * 0.3);
	// 	k[8] = 1.0 / 144 * (-10 + 12 * 0.3); k[9] = 1.0 / 144 * (3 - 12 * 0.3);
	// 	k[10] = 1.0 / 144 * (-3 + 0 * 0.3); k[11] = 1.0 / 144 * (-3 + 12 * 0.3);
	// 	k[12] = 1.0 / 144 * (-4 + 12 * 0.3); k[13] = 1.0 / 144 * (-8 + 12 * 0.3);
		
	// 	double K1[6][6] = { {k[0], k[1], k[1], k[2], k[4], k[4]},
	...
	// 	double K2[6][6] = { {k[8], k[7], k[11], k[5], k[3], k[6]},
	...
	// 	double K3[6][6] = { {k[5], k[6], k[3], k[8], k[11], k[7]},
	...
	// 	double K4[6][6] = { {k[13], k[10], k[10], k[12], k[9], k[9]},
	...
	// 	double K5[6][6] = { {k[0], k[1], k[7], k[2], k[4], k[3]},
	...
	// 	double K6[6][6] = { {k[13], k[10], k[6], k[12], k[9], k[11]},
	...
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 6][j + 6] = as * K5[i][j];
	// 			}
	// 		}
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 6][j + 12] = as * K6[i][j];
	// 			}
	// 		}
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 6][j + 18] = as * K3[j][i];
	// 			}
	// 		}////
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	...
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 12][j + 6] = as * K6[i][j];
	// 			}
	// 		}
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 12][j + 12] = as * K5[j][i];
	// 			}
	// 		}
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 12][j + 18] = as * K2[j][i];
	// 			}
	// 		}////
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	...
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 18][j + 6] = as * K3[i][j];
	// 			}
	// 		}
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 18][j + 12] = as * K2[i][j];
	// 			}
	// 		}
	// 		for (int i = 0; i < 6; i++) {
	// 			for (int j = 0; j < 6; j++) {
	// 				KE[i + 18][j + 18] = as * K1[j][i];
	// 			}
	// 		}
	// 	}
    // }
